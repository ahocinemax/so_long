...
void	ft_init_texture(t_sl *sl)
{
	...
	sl->game.img.address = mlx_get_data_addr(sl->game.img.img, &sl->game.img.bpx, \
		&sl->game.img.line_l, &sl->game.img.endian);
	sl->wall.img.img = mlx_xpm_file_to_image(sl->mlx_ptr, "./img/wall.xpm", \
		&sl->wall.width, &sl->wall.height);
	sl->wall.img.address = mlx_get_data_addr(sl->wall.img.img, &sl->wall.img.bpx, \
		&sl->wall.img.line_l, &sl->wall.img.endian);
	sl->door1.img.img = mlx_xpm_file_to_image(sl->mlx_ptr, "./img/door1.xpm", \
		&sl->door1.width, &sl->door1.height);
	sl->door1.img.address = mlx_get_data_addr(sl->door1.img.img, &sl->door1.img.bpx, \
		&sl->door1.img.line_l, &sl->door1.img.endian);
	sl->door2.img.img = mlx_xpm_file_to_image(sl->mlx_ptr, "./img/door2.xpm", \
		&sl->door2.width, &sl->door2.height);
	sl->door2.img.address = mlx_get_data_addr(sl->door2.img.img, &sl->door2.img.bpx, \
		&sl->door2.img.line_l, &sl->door2.img.endian);
	sl->back.img.img = mlx_xpm_file_to_image(sl->mlx_ptr, "./img/back.xpm", \
		&sl->back.width, &sl->back.height);
	sl->back.img.address = mlx_get_data_addr(sl->back.img.img, &sl->back.img.bpx, \
		&sl->back.img.line_l, &sl->back.img.endian);
}
